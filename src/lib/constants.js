...
export const NAV_CFG = {
  ...
  dev:       [{ sec: 'Configuració IA', items: [{ id: 'dv', icon: '🤖', label: 'Normes IA' }, { id: 'dv_context', icon: '🏫', label: 'Context IA' }, { id: 'dv_logs', icon: '📜', label: 'Registre HorarIA' }] }],
};
...
export const BNAV = {
  ...
  dev:       [{ id: 'dv', icon: '🤖', label: 'Normes' }, { id: 'dv_context', icon: '🏫', label: 'Context' }, { id: 'dv_logs', icon: '📜', label: 'Registre' }],
};
...
export const PAGE_TITLES = {
  ...
  di: 'Historial', df: 'Informes', dv: 'Normes IA', dv_context: 'Context IA', dv_logs: 'Registre HorarIA',

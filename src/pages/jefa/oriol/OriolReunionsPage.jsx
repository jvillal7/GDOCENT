...
export default function OriolReunionsPage() {
  ...
  async function load() {
    ...
    try {
      ...
      const stored = res?.[0]?.oriol_reunions;
  ...
  async function guardar() {
    setSaving(true);
    try {
      await api.saveOriolReunions({ text, data: avui });
      showToast('✓ Guardat');
  ...
  return (
    <>
      <div className="page-hdr">
        <h1>Reunions i aspectes organitzatius</h1>
        ...
        {loading ? (
          ...
          <div style={{ padding: 14, display: 'flex', flexDirection: 'column', gap: 12 }}>
            <textarea
              className="f-ctrl"
              rows={10}
              placeholder={'Escriu aquí les reunions i aspectes organitzatius del dia...\n\nEx:\n• 10:00h — Reunió de cicle a la sala de mestres\n• 12:30h — Visita logopeda extern (Aula G5)\n• Avisar tutors de 3r sobre l\'excursió de divendres'}
              value={text}
